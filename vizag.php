...
$vizag="select * from companies where LOCATION_ID=3";
$vizquery=mysqli_query($conn,$vizag);

if(mysqli_num_rows($vizquery) > 0)
{

	while($exevizag= mysqli_fetch_assoc($vizquery))
	{
		echo "<tr><td>".$exevizag['C_ID']."</td><td>".$exevizag['C_NAME']."</td><td>".$exevizag['GENER']."</td><td>".$exevizag['No_of_Posts']."</td><td>".$exevizag['Last_Date']."</td></tr>";
	}
