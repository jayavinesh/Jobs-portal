...
$guntur="select * from companies where LOCATION_ID=6";
$gunquery=mysqli_query($conn,$guntur);

if(mysqli_num_rows($gunquery) > 0)
{

	while($exeguntur= mysqli_fetch_assoc($gunquery))
	{
		echo "<tr><td>".$exeguntur['C_ID']."</td><td>".$exeguntur['C_NAME']."</td><td>".$exeguntur['GENER']."</td><td>".$exeguntur['No_of_Posts']."</td><td>".$exeguntur['Last_Date']."</td></tr>";
	}
